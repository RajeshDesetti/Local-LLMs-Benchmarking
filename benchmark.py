...
FIXED_PROMPT_PREFIX = "Answer in around 100 words. Be detailed and complete.\n\n"
...
def query_model(model: str, prompt: str, temperature: float = 0.0) -> dict:
    ...
    return {
        ...
        "words_per_second": wps,
        "word_count": word_count,
        "memory_mb": 0.0,   # API hides actual memory
        "error": error or "",
    }
...
def run_benchmark(output_file="results/benchmark_results.csv"):
    ...
    for model in models:
        ...
        for i, prompt_data in enumerate(PROMPTS):
            ...
            final_prompt = FIXED_PROMPT_PREFIX + prompt_data["prompt"]
            result = query_model(model, final_prompt, temperature=0.0)
